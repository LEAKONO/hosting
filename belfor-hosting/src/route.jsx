...
// User routes
const UserOverview = lazy(() => import('./pages/user/dashboard/Overview'));
const UserServices = lazy(() => import('./pages/user/dashboard/Services'));
const UserQuickActions = lazy(() => import('./pages/user/dashboard/QuickActions'));
...
const UserTicketList = lazy(() => import('./pages/user/tickets/List'));
const UserNewTicket = lazy(() => import('./pages/user/tickets/New'));
const UserViewTicket = lazy(() => import('./pages/user/tickets/View'));
  ...
  return (
    <Routes>
      ...
      <Route path="/user" element={<RequireAuth><UserLayout /></RequireAuth>}>
        ...
        <Route path="dashboard/quick-actions" element={<UserQuickActions />} />
        ...
        <Route path="tickets/:id" element={<UserViewTicket />} />
